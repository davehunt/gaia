...
class TestEnduranceAirplaneMode(GaiaEnduranceTestCase):
    ...
    def test_endurance_airplane_mode(self):
        self.drive(test=self.airplane_mode, app='settings')
    ...
    def airplane_mode(self):
        ...
        self.marionette.find_element(*self._airplane_mode_button_locator).tap()
        ...
        self.marionette.find_element(*self._airplane_mode_enabled_button_locator).tap()
    ...
    def verify_cell(self, expect_enabled):
        ...
        self.marionette.find_element(*self._cell_data_menu_item_locator).tap()
        time.sleep(2)
